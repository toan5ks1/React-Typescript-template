declare module NsReactAdmin {
    ...
    export interface TempMessageFeatureToggle {
        duplicationRow: string;
        alreadyRegisteredRow: string;
        notFollowTemplate: string;
    }
    export interface Message {
        ...
        areYouSureYouWantToDiscardWhatYouSelected: string;
        youHaveAppliedLocationSuccessfully: string;
        importStudentInProgress: string;
        invalidNumberRow: string;
        duplicationRow: string;
        alreadyRegisteredRow: string;
        notFollowTemplate: string;
        otherErrorImport: string;
        invalidMaxSizeFile: string;
        emptyFile: string;
        wrongTemplate: string;
        importedStudentsSuccessfully: string;
        importParentInProgress: string;
        importedParentsSuccessfully: string;
        notFollowParentTemplate: string;
        missingMandatory: string;
        notMatchRelationshipAndEmailStudent: string;
    ...
    export interface ManabieError {
        ...
        permission_denied: string;
        teacher_jprep_permission_denied: string;
        internals: string;
        disconnect: string;
    ...
    export interface RootObject {
        ...
        tempMessageFeatureToggle: TempMessageFeatureToggle;
    }
}
