...
import brightcoveServiceYasuo from "src/squads/payment/service/yasuo/brightcove-yasuo-service/brightcove-yasuo-reader.query";

jest.mock(
    "src/squads/payment/service/yasuo/brightcove-yasuo-service/brightcove-yasuo-reader.query",
    () => ({
        __esModule: true,
        default: {
...
describe("brightcove-service", () => {
    it("should return Brightcove profile", async () => {
        ...
        const profile = await brightcoveService.query.paymentGetBrightcoveProfile();
