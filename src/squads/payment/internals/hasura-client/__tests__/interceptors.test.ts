...
import { HasuraError } from "src/squads/payment/internals/hasura-client/errors";
import {
    injectCatchResponseInterceptor,
    injectRefreshTokenInterceptor,
    injectMetadataInterceptor,
} from "src/squads/payment/internals/hasura-client/interceptors";
...
jest.mock("src/squads/payment/internals/reactive-storage", () => {
    return {
        get: jest.fn(),
    };
});
