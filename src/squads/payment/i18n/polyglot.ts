...
import { PjOwner } from "src/squads/payment/typings/configuration";
...
import { I18nProvider, LanguageEnums } from "src/squads/payment/typings/i18n-provider";
...
const setPolyglot = ({ messages, locale }: { messages: TranslationKeys; locale: string }) => {
