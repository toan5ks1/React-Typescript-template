...
const TestComponent = () => {
    ...
    const { fields } = useFieldArray<OrderFormValues, `students.${number}.productFieldArrayItems`>({
...
describe("ProductListItem interactions with frequency based package product", () => {
    const firstProduct = mockFrequencyBasedPackageProductList[0];
    const secondProduct = mockFrequencyBasedPackageProductList[1];

    it("should change the start date to empty when user chooses another product", async () => {
