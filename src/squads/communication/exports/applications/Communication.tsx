import "src/squads/communication/styles/mui-classname-setup";
...
import permission from "src/squads/communication/internals/permission";

import Loading from "src/components/Loading";

import AppProvider from "src/app/AppProvider";
import "src/index.css";
import PermissionProvider from "src/squads/communication/contexts/PermissionProvider";
...
import MicroRouting from "src/squads/communication/routing/MicroRouting";
...
function Component({ basename, routeHistory }: { basename: string; routeHistory: History }) {
    const role = useCommunicationUpdatePermissionMicroApplication();
