...
import { HasuraError } from "src/squads/communication/internals/hasura-client/errors";
import {
    injectCatchResponseInterceptor,
    injectRefreshTokenInterceptor,
    injectMetadataInterceptor,
} from "src/squads/communication/internals/hasura-client/interceptors";
...
jest.mock("src/squads/communication/internals/reactive-storage", () => {
    return {
        get: jest.fn(),
    };
});
