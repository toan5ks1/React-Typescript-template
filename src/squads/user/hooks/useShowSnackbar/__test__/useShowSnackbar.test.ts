import { SnackbarActions } from "src/squads/user/stores/snackbar/actions";
...
import useEnableManaEventEmitter from "src/squads/user/hooks/useEnableManaEventEmitter";
import useSnackbarManaEventEmitter from "src/squads/user/hooks/useSnackbarManaEventEmitter";
import { UseTranslateParams } from "src/squads/user/hooks/useTranslate";
...
jest.mock("src/squads/user/hooks/useEnableManaEventEmitter", () => {
    return {
        __esModule: true,
        default: jest.fn(),
    };
