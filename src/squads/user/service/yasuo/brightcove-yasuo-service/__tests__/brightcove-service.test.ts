import brightcoveService from "src/squads/user/service/yasuo/brightcove-yasuo-service/brightcove-yasuo-service";
...
jest.mock(
    "src/squads/user/service/yasuo/brightcove-yasuo-service/brightcove-yasuo-reader.query",
    () => ({
        __esModule: true,
        default: {
...
describe("brightcove-service", () => {
    it("should return Brightcove profile", async () => {
        ...
        const profile = await brightcoveService.query.userGetBrightcoveProfile();
