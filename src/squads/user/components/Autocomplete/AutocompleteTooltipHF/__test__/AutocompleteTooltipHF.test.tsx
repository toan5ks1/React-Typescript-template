...
import { TestHookFormProvider } from "src/squads/user/test-utils/providers";
import { changeAutocompleteInput } from "src/squads/user/test-utils/utils";

import AutocompleteTooltipHF, { AutocompleteTooltipHFProps } from "../AutocompleteTooltipHF";

import { fireEvent, render, RenderResult, screen, waitFor } from "@testing-library/react";

describe("<AutocompleteTooltipHF />", () => {
    let wrapper: RenderResult;

    const props: AutocompleteTooltipHFProps<FieldValues> = {
        name: "test",
        optionLabelKey: "name",
        options: [
            { id: 1, name: "AAA" },
    ...
    it("should match snapshot", async () => {
        await waitFor(() =>
            expect(
                wrapper.queryByTestId("AutocompleteTooltipBase__loading")
...
describe("<AutocompleteTooltipHF multiple/> should render chips correctly", () => {
    let wrapper: RenderResult;
...
describe("<AutocompleteTooltipHF /> required error", () => {
    let wrapper: RenderResult;
...
describe("<AutocompleteTooltipHF /> render default value", () => {
    let wrapper: RenderResult;
    ...
    it("should render default value and isDirty = false", async () => {
        ...
        expect(wrapper.getByTestId("AutocompleteTooltipBase__input")).toHaveAttribute(
            "value",
