...
import useLocale from "src/squads/timesheet/hooks/useLocale";

// TODO: wrap into router user squad after MuiPickersUtilsProvider is removed in the MainApp and AppProvider
