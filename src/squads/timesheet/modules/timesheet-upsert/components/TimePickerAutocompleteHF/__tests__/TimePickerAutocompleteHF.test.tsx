...
describe("<TimePickerAutocompleteHF />", () => {
    ...
    it("should render correct options each 15-minutes step", async () => {
        within(wrapper.getByTestId("TimePickerAutocompleteHF__autocomplete"))
            .getByTitle("Open")
            .click();
        await waitFor(() => {
