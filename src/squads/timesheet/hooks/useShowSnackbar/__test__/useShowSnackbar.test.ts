import { SnackbarActions } from "src/squads/timesheet/stores/snackbar/actions";

import type { AlertBaseProps } from "src/components/Alerts/AlertBase";

import useShowSnackbar, { sanitizerMsg, UseShowSnackbarParams } from "../useShowSnackbar";

import { renderHook, act } from "@testing-library/react-hooks";
import useEnableManaEventEmitter from "src/squads/timesheet/hooks/useEnableManaEventEmitter";
import useSnackbarManaEventEmitter from "src/squads/timesheet/hooks/useSnackbarManaEventEmitter";
import { UseTranslateParams } from "src/squads/timesheet/hooks/useTranslate";
...
jest.mock("src/squads/timesheet/hooks/useEnableManaEventEmitter", () => {
    return {
        __esModule: true,
        default: jest.fn(),
    };
