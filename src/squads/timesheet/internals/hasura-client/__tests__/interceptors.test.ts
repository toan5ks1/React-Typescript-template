...
import { HasuraError } from "src/squads/timesheet/internals/hasura-client/errors";
import {
    injectCatchResponseInterceptor,
    injectRefreshTokenInterceptor,
    injectMetadataInterceptor,
} from "src/squads/timesheet/internals/hasura-client/interceptors";
...
jest.mock("src/squads/timesheet/internals/reactive-storage", () => {
    return {
        get: jest.fn(),
    };
});
