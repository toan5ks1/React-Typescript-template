...
import { getStatusConversionTask } from "src/squads/lesson/models/conversion-task";
import { MediaConversionHasura, MediaHasura } from "src/squads/lesson/models/media";
import { IDataProvider } from "src/squads/lesson/service/service-types";
import {
    LessonConvertActionTypes,
    NsLessonConvert,
    LessonConvertActions,
} from "src/squads/lesson/store/lesson-convert/actions";
import { Material } from "src/squads/lesson/store/lesson-convert/lesson-convert-types";
import {
    getMaterialIds,
    isAllConvertSuccessfully,
    isLessonConvertFailed as checkIsFailed,
} from "src/squads/lesson/store/lesson-convert/selectors";
