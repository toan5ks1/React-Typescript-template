...
import BrightcoveLogoIcon from "src/components/SvgIcons/BrightcoveLogoIcon";
...
const FormUploadBrightCove = ({ onChange, isOptional = false }: FormUploadBrightCoveProps) => {
    ...
    const onUpload = useCallback(() => {
        const brightCoveIds = parseBrightcoveVideoInfos(value);
            ...
            <Grid container spacing={1} alignItems="center">
                ...
                <Grid item xs sx={sx.gridContainer}>
                    <TextFieldBase
                        ...
                        size="small"
                        margin="none"
                        label={t(`resources.common.brightcoveVideoLink`)}
                        value={value}
