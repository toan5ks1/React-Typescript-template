import AutocompleteBase, { getOptionSelected, AutocompleteBaseProps } from "../AutocompleteBase";
...
function renderComponent<T>(props: AutocompleteBaseProps<T>) {
    const {
        options = [],
        renderTags,
        onChange,
...
describe("<AutocompleteBase /> with getOptionSelectedField", () => {
    const props = {
        options: [
            {
                id: "1",
...
describe("<AutocompleteBase /> with function optionLabel", () => {
