...
import { HasuraError } from "src/squads/lesson/internals/hasura-client/errors";
import {
    injectCatchResponseInterceptor,
    injectRefreshTokenInterceptor,
    injectMetadataInterceptor,
} from "src/squads/lesson/internals/hasura-client/interceptors";
...
jest.mock("src/squads/lesson/internals/reactive-storage", () => {
    return {
        get: jest.fn(),
    };
});
