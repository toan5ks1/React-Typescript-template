...
import { FilterTimeType } from "src/squads/lesson/common/types";
import { UseFormType } from "src/squads/lesson/typings/react-hook-form";
...
export const convertToFilterTimeValue = (value: FilterTimeType): string | null => {
