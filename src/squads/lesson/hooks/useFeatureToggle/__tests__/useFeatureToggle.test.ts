...
import useFeatureController from "src/squads/lesson/hooks/useFeatureController";

jest.mock("src/squads/lesson/hooks/useFeatureController", () => jest.fn());
...
describe(useFeatureToggle.name, () => {
    ...
    it("should return isEnabled is true isFeatureEnabled return true", () => {
        const feature: Features = Features.LESSON_MANAGEMENT;
