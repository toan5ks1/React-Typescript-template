...
export interface TableStudentSubscriptionV2Props {
...
export const transformBetweenSkeletonAndTypography = ({
    content,
    loading = false,
    dataTestId = "TableStudentSubscriptionV2__rowContent",
}: {
...
const TableStudentSubscriptionV2 = (props: TableStudentSubscriptionV2Props) => {
    const {
        studentInfosList,
        pagination,
        onSelect,
        ...
        const tableColumns: TableColumn<LessonManagementStudentInfo>[] = [
            {
                ...
                render: (record) => (
                    <TypographyMaxLines
                        variant="body2"
                        maxLines={2}
                        data-testid="TableStudentSubscriptionV2__studentName"
                    >
            ...
            },
            {
                ...
                render: (record) => {
                    const studentGrade = getStudentGradeName(record.grade);

                    return transformBetweenSkeletonAndTypography({
                        content: studentGrade ? t(studentGrade) : undefined,
                        loading: isLoadingGrades,
                        dataTestId: "TableStudentSubscriptionV2__grade",
                    });
                },
                cellProps: {
                    style: { width: "11%" },
            ...
            },
            {
                ...
                render: (record) => (
                    <TypographyMaxLines
                        variant="body2"
                        maxLines={2}
                        data-testid="TableStudentSubscriptionV2__courseName"
                    >
            ...
            },
            {
                ...
                render: (record) =>
                    transformBetweenSkeletonAndTypography({
                        ...
                        loading: isLoadingGrades,
                        dataTestId: "TableStudentSubscriptionV2__className",
                    }),
                cellProps: {
                    style: { width: "18%" },
                },
            },
            {
                ...
                render: (record) => {
                    ...
                    return transformBetweenSkeletonAndTypography({
                        ...
                        dataTestId: "TableStudentSubscriptionV2__locationName",
                    });
                },
                cellProps: {
                    style: { width: "14%" },
    ...
    return (
        <TableWithCheckbox<LessonManagementStudentInfo>
            ...
            footer={{ pagination }}
            withIndex
            tableProps={{ "data-testid": "TableStudentSubscriptionV2__tableContainer" }}
        />
    );
};

export default TableStudentSubscriptionV2;
