...
import TableStudentInfoV2, {
    TableStudentInfoV2Props,
} from "src/squads/lesson/pages/LessonManagement/components/Tables/TableStudentInfoV2";
...
const renderTableStudentInfoV2 = (props: TableStudentInfoV2Props) => {
    render(
        <TranslationProvider>
            <TestThemeProvider>
                <TableStudentInfoV2 {...props} />
            </TestThemeProvider>
        </TranslationProvider>
    );
};

describe("TableStudentInfoV2", () => {
    const props: TableStudentInfoV2Props = {
    ...
    it("should render columns", () => {
        renderTableStudentInfoV2(props);
