...
export interface TableLessonUpsertStudentsInfoProps {
...
const TableLessonUpsertStudentsInfo = (props: TableLessonUpsertStudentsInfoProps) => {
    const {
        studentInfosList,
        updateStudentAttendance,
        onSelect,
        ...
        return [
            {
                ...
                render: (record) => (
                    <TypographyMaxLines
                        maxLines={2}
                        variant="body2"
                        data-testid="TableLessonUpsertStudentsInfo__columnStudentName"
                    >
            ...
            },
            {
                ...
                render: (record) => (
                    <TypographyPrimary
                        variant="body2"
                        data-testid="TableLessonUpsertStudentsInfo__columnGrade"
                    >
            ...
            },
            {
                ...
                render: (record) => (
                    <TypographyMaxLines
                        maxLines={2}
                        variant="body2"
                        data-testid="TableLessonUpsertStudentsInfo__columnCourseName"
                    >
                ...
                render: (record, index) => {
                    ...
                    return (
                        <AutocompleteAttendanceStatus
                            ...
                            data-testid="TableLessonUpsertStudentsInfo__autocompleteAttendance"
                            ...
                            componentsProps={{
                                clearIndicator: {
                                    // @ts-ignore:next-line
                                    "data-testid": "TableLessonUpsertStudentsInfo__iconClear",
                                    onClick: () => {
                    ...
                    return (
                        location && (
                            <TypographyMaxLines
                                maxLines={2}
                                variant="body2"
                                data-testid="TableLessonUpsertStudentsInfo__columnCenterName"
                            >
                                {location.name}
                            </TypographyMaxLines>
                        )
    ...
    return (
        <TableWithCheckbox<LessonManagementStudentInfo>
            ...
            tableProps={{ "data-testid": "TableLessonUpsertStudentsInfo__root" }}
            columns={columns}
            showHeader={true}
...
export default TableLessonUpsertStudentsInfo;
