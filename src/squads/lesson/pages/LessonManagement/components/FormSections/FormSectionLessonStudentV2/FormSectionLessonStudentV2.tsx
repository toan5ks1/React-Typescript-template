...
import TableStudentsInfoWithActionsV2 from "src/squads/lesson/pages/LessonManagement/components/Tables/TableStudentsInfoWithActionsV2";
...
interface FormSectionLessonStudentV2Props {
    isSavingDraftLesson: boolean;
}

const FormSectionLessonStudentV2 = (props: FormSectionLessonStudentV2Props) => {
    ...
    return (
        <Controller<LessonManagementUpsertFormType, "learners">
            ...
            render={({ fieldState: { error }, field: { onChange, value: learners } }) => {
                ...
                return (
                    <TableStudentsInfoWithActionsV2
                        studentInfosList={learners}
...
export default FormSectionLessonStudentV2;
