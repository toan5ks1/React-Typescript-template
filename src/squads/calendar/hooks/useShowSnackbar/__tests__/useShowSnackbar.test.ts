import { SnackbarActions } from "src/squads/calendar/store/snackbar/actions";
...
import useEnableManaEventEmitter from "src/squads/calendar/hooks/useEnableManaEventEmitter";
import useSnackbarManaEventEmitter from "src/squads/calendar/hooks/useSnackbarManaEventEmitter";
import { UseTranslateParams } from "src/squads/calendar/hooks/useTranslate";
...
jest.mock("src/squads/calendar/hooks/useEnableManaEventEmitter", () => {
    return {
        __esModule: true,
        default: jest.fn(),
    };
