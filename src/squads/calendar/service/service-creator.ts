...
import {
    ...
    UseQueryOptions,
} from "src/squads/calendar/typings/data-types";

import usePagination, { UsePaginationReturn } from "src/squads/calendar/hooks/usePagination";
...
interface PaginationWithTotal extends Omit<UsePaginationReturn, "setLimit" | "setOffset"> {
    count: number;
}
