...
import usePagination, { UsePaginationReturn } from "src/squads/syllabus/hooks/data/usePagination";
                ...
                ...rqUseQuery<T, Error, MappedType>(
                    ...
                    async (context) => {
                        try {
                            ...
                            logger.warn(`[UseQuery ${safeStringify(context.queryKey)}]`, e);
...
export const withSpecificMigrateAction = (action: string) => `${action}_migrationEureka`;
