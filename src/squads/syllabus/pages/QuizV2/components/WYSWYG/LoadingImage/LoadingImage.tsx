...
const LoadingImage = function ({
    ...
    return (
        <Box data-offset-key={offsetKey} data-testid="LoadingImage__root">
            <Box sx={sx.wrapper}>
                <Box
                    component="img"
                    src={data}
                    alt="wyswyg loading image"
                    onLoad={handleOnLoad}
                    data-testid="LoadingImage__img"
                />
                <Box sx={[sx.spinner, sx[spinnerSize]]} data-testid="LoadingImage__spinner">
