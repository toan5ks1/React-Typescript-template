        ...
        <Box sx={{ textAlign: "center" }}>
            ...
            {editMode && (
                <SpacingGroup direction="horizontal" spacing={8}>
                    <ButtonBase color="default" onClick={onCancel} data-testid="BlockImage__cancel">
                        {t("ra.common.action.cancel")}
                    </ButtonBase>
                    <ButtonBase color="error" onClick={onRemove} data-testid="BlockImage__remove">
