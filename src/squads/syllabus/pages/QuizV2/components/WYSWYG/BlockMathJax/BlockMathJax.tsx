...
import { Box, Button, Card, TextareaAutosize, Theme } from "@mui/material";
...
const BlockMathJax = ({ blockProps, block, contentState }: BlockPluginProps) => {
    ...
    return (
        <Box data-testid="BlockMathJax__root">
            <Box
                sx={sx.value}
                ref={nodeMathJax}
                onClick={onClick}
                data-testid="BlockMathJax__formula"
            />
            <Popper
                open={editMode}
                anchorEl={nodeMathJax.current}
                onClose={onClickAway}
                data-testid="BlockMathJax__popup"
            >
                <Card sx={sx.editWrapper}>
                    ...
                    <Box sx={sx.btnWrapper}>
                        ...
                        <Button
                            ...
                            color="primary"
                            onClick={onDone}
                            data-testid="BlockMathJax__done"
                        >
