...
import { Box, Card, TextareaAutosize } from "@mui/material";
...
const InlineMathJax = function (props: InlinePluginProps) {
    ...
    return (
        <Box component="span" data-offset-key={offsetKey} data-testid="InlineMathJax__root">
            <Box
                component="span"
                ref={nodeMathJax}
                onClick={onClick}
                data-testid="InlineMathJax__formula"
            >
                {texValue}
            </Box>
            <Popper
                ...
                onClose={onClickAway}
                data-testid="InlineMathJax__popup"
            >
                <Card sx={sx.card} square>
                    ...
                    <Box>
                        <ButtonBase
                            ...
                            color="primary"
                            onClick={onDone}
                            data-testid="InlineMathJax__done"
                        >
                            {t("ra.common.done")}
                        </ButtonBase>
                    </Box>
