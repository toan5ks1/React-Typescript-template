import TaskAssignmentCreate from "../TaskAssignmentCreate";
...
jest.mock("react-router", () => {
    ...
    return {
        ...
        ...actual,
        useLocation: () => ({
            pathname: "/syllabus/task_assignments/create",
...
const renderUtil = async () => {
    const wrapper = render(<TaskAssignmentCreate />, { wrapper: TestAppWithQueryClient });
...
describe(TaskAssignmentCreate.name, () => {
