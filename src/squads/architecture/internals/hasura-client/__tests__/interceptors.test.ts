...
import { HasuraError } from "src/squads/architecture/internals/hasura-client/errors";
import {
    injectCatchResponseInterceptor,
    injectRefreshTokenInterceptor,
    injectMetadataInterceptor,
} from "src/squads/architecture/internals/hasura-client/interceptors";
...
jest.mock("src/squads/architecture/internals/reactive-storage", () => {
    return {
        get: jest.fn(),
    };
});
