...
class StudentEntryExitMgmtQuery extends InheritedHasuraServiceClient {
    async getMany(
...
const studentEntryExitMgmtQueries = new StudentEntryExitMgmtQuery(
    appConfigs,
    "entryexitmgmtGraphQL",
    doQuery
);

export default studentEntryExitMgmtQueries;
