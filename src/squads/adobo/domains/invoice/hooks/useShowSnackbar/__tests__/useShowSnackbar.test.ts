import { SnackbarActions } from "src/squads/adobo/domains/invoice/store/snackbar/actions";

import { AlertBaseProps } from "src/components/Alerts/AlertBase";

import { renderHook, act } from "@testing-library/react-hooks";
import useEnableManaEventEmitter from "src/squads/adobo/domains/invoice/hooks/useEnableManaEventEmitter";
import useShowSnackbar, {
    sanitizerMsg,
    UseShowSnackbarParams,
} from "src/squads/adobo/domains/invoice/hooks/useShowSnackbar";
import useSnackbarManaEventEmitter from "src/squads/adobo/domains/invoice/hooks/useSnackbarManaEventEmitter";
import { UseTranslateParams } from "src/squads/adobo/domains/invoice/hooks/useTranslate";
...
jest.mock("src/squads/adobo/domains/invoice/hooks/useEnableManaEventEmitter", () => {
    return {
        __esModule: true,
        default: jest.fn(),
    };
