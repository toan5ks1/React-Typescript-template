...
import { Configs } from "src/squads/adobo/domains/invoice/i18n/resource-types/config";
import { LanguageEnums } from "src/squads/adobo/domains/invoice/typings/i18n-provider";
