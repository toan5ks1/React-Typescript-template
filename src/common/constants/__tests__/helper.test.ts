import { convertEnumKeys, getEnumString, convertString } from "../helper";
...
describe(convertString.name, () => {
    it("should convert to string", () => {
        expect(convertString("string")).toEqual("string");
        expect(convertString(null)).toEqual("");
        expect(convertString(undefined)).toEqual("");
    });
});
