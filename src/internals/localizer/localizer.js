// This file is copied from https://github.com/jquense/react-big-calendar/blob/master/src/localizer.js
...
function inEventRange({ event: { start, end }, range: { start: rangeStart, end: rangeEnd } }) {
    ...
    let endsAfterStart = sameMin ? gt(end, rangeStart, "minutes") : gte(end, rangeStart, "minutes");
