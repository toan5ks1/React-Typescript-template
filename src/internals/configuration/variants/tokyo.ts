...
const endpointPreproduction = {
    gRPC: "https://web-api.prep.tokyo.manabie.io:31400",
    bobGraphQL: "https://admin.prep.tokyo.manabie.io:31600",
    eurekaGraphQL: "https://admin.prep.tokyo.manabie.io:31600/eureka",
    fatimaGraphQL: "https://admin.prep.tokyo.manabie.io:31600/fatima",
    invoicemgmtGraphQL: "https://admin.prep.tokyo.manabie.io:31600/invoicemgmt",
    entryexitmgmtGraphQL: "https://admin.prep.tokyo.manabie.io:31600/entryexitmgmt",
    timesheetGraphQL: "https://admin.prep.tokyo.manabie.io:31600/timesheet",
    OCR: "https://asia-east2-content-management-syste-c40d1.cloudfunctions.net",
};
...
const endpointProduction = {
    ...
    entryexitmgmtGraphQL: "https://admin.prod.tokyo.manabie.io:31600/entryexitmgmt",
...
const unleashPreprod: UnleashConfig = {
    url: "https://admin.prep.tokyo.manabie.io:31600/unleash/proxy",
    environment: "prod",
    ...unleashCommonConfig,
};

const unleashProd: UnleashConfig = {
    url: "https://admin.prod.tokyo.manabie.io:31600/unleash/proxy",
    environment: "prod",
    ...unleashCommonConfig,
};
